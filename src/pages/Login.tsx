...
import { fetchLogin, IUser, selectIsAuth } from '../redux/slices/authSlice';
...
const Login: FC = () => {
    ...
    const onSubmit: SubmitHandler<IAuthParams> = async (values) => {
                ...
                <div className="p-6 space-y-4">
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit(onSubmit)} >
                        ...
                        <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                            Если у вас нет аккаунта. <span onClick={() => navigate('/register')} className="font-sm font-bold xl:font-medium text-primary-600 hover:underline dark:text-primary-500 cursor-pointer">Зарегистрироваться?</span>
                        </p>
                    </form>
                </div>
            </div>
